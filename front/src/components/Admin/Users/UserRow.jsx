...
const UserRow = ({item, index, showModeretaion}) =>{
                ...
                showModeretaion &&(
                    <div className={s.item__moderation}>
                        <div className={s.select__wrap}>
                            <select className={s.select} name="" id=""> 
                                {
                                    userTypes.map((item, index)=>{
                                        return(
                                            <option className={s.option} key={item.value} index={index} value={item.value}>{item.title}</option>
                                        )
                                    })
                                }
                            </select>
                            ...
                            <div className={s.select__wrap__in}>
                                {
                                    userTypes.map((item, index)=>{
                                        return(
                                            <div className={`${showSelect ? s.select : s.select__show}`} index={index} onClick={(e)=>{
